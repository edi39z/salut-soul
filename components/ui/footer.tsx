            ...
            <div className="py-12">
                <div className="container-academic">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        >
                            <div className="flex items-center space-x-3 mb-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-slate-400">Universitas Terbuka</p>
                                </div>
                            </div>
                        ...
                        >
                            <h3 className="text-lg font-semibold mb-6">Program Populer</h3>
                            <div className="space-y-3">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="tel:+6281234567890" className="text-slate-300 hover:text-white transition-colors">
                                            +62 812-3456-7890
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <a href="mailto:info@salutsoul.ac.id" className="text-slate-300 hover:text-white transition-colors">
            ...
            <div className="border-t border-slate-700 py-6">
                <div className="container-academic">
                    ...
                    >
                        ...
                        <div className="text-slate-400 text-sm">Dibuat untuk pendidikan Indonesia yang lebih baik</div>
                    </motion.div>
                </div>
            </div>
        </footer>
